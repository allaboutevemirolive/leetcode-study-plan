// https://leetcode.com/problems/search-a-2d-matrix/solutions/2336174/rust-2-solutions-with-tests/
struct Solution {}

impl Solution {
	// here we unwinding the matrix since every line of it is sorted O(log(n*m))
	...
	// here we trying to find a line first, then apply a binary search O(n * log(m))
