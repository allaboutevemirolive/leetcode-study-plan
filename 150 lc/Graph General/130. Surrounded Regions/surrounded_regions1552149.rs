// https://leetcode.com/problems/surrounded-regions/solutions/1552149/rust-bfs/
            ...
            for _ in 0..queue.len() {
                if let Some((row, col)) = queue.pop_front() {
                    for d in 0..4 {
                        ...
                        if row_nxt < 0 || col_nxt < 0 || row_nxt as usize >= n_rows || col_nxt as usize >= n_cols|| board[row_nxt as usize][col_nxt as usize] != *CELL_O{
                            continue;
                        }
