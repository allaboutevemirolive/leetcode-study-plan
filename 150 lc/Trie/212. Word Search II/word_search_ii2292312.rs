// https://leetcode.com/problems/word-search-ii/solutions/2292312/rust-trie-dfs/
// time complexity : O( max(W*w, m*n*w) )
// space complexity : O(26 ^ w)
//      where W -> length of words array
//            w -> max word length
//            m -> board rows
//            n -> board columns
//
